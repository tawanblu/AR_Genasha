...
<body>
    ...
    <div style="margin-top: 70px;" class="container pb-5">
        ...
        <div class="d-flex justify-content-center gap-3 mb-5 overflow-auto pb-2" style="scrollbar-width: none;">
            <button class="filter-btn active" onclick="filterType('all', this)">All Categories</button>
                    ...
                    <div class="card place-card h-100">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <button type="button" class="btn-view mt-3"
                                ...
                                data-images="<?= htmlspecialchars($res_images_json, ENT_QUOTES, 'UTF-8') ?>"
                                data-detail="<?= htmlspecialchars($res['detail'] ?? 'ไม่มีรายละเอียด') ?>"
                                data-reviews="<?= htmlspecialchars($res_reviews_json, ENT_QUOTES, 'UTF-8') ?>">
                                View Details & Review
                            </button>
                        </div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (resDetailModal) {
                resDetailModal.addEventListener('show.bs.modal', function(event) {
                    ...
                    // หั่นและใส่ Category Badge ใน Modal หลายๆ อัน
