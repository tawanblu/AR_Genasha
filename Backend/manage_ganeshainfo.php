    ...
    if (isset($_POST['add'])) {
        ...
        header("Location: manage_ganeshainfo.php");
        exit();
    }
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($row2 = $r2->fetch_assoc()) {
            ...
            if (file_exists($f) && !empty($row2['img_ganesha'])) unlink($f);
        }
            ...
            <div class="topbar anim anim-1">
                ...
                <div class="topbar-actions">
                    <button type="button" class="btn-add" data-bs-toggle="modal" data-bs-target="#addModal">
                        <i class="bi bi-plus-lg"></i> เพิ่มข้อมูล ประวัติพระพิฆเนศ
                    </button>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center; display: flex; gap: 8px; justify-content: center; border-bottom: none;">
                                    ...
                                    <a href="?delete=<?= $row['info_id'] ?>" class="btn-del" onclick="return confirm('Delete this data?')">
